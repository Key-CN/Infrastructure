...
import static io.keyss.keytools.utils.RxFileTool.getDataColumn;
import static io.keyss.keytools.utils.RxFileTool.isDownloadsDocument;
import static io.keyss.keytools.utils.RxFileTool.isExternalStorageDocument;
import static io.keyss.keytools.utils.RxFileTool.isGooglePhotosUri;
import static io.keyss.keytools.utils.RxFileTool.isMediaDocument;
...
public class RxPhotoTool {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            ToastUtil.getToast("请先获取写入SDCard权限");
        } else {
